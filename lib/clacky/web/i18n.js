...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "share.tooltip":            "Share",
      "share.copy.1":             "I'm building with {{brand}} — an AI agent that actually gets things done. Highly recommend.",
      "share.copy.2":             "Been using {{brand}} for my AI tasks lately. It just ships. Worth a look.",
      "share.copy.3":             "If you build with AI, give {{brand}} a try — it's become my daily driver.",
      "share.copy.4":             "{{brand}} quietly does the work while I think. Solid tool, sharing it here.",
      ...
      "share.poster.tagline":     "I get things done faster with {{brand}}.",
    ...
    zh: {
      ...
      "share.tooltip":            "分享",
      "share.copy.1":             "我在用 {{brand}} —— 一个真正能把活干完的 AI 助手，强烈推荐。",
      "share.copy.2":             "最近 AI 任务都丢给 {{brand}} 跑，是真能交付，值得看看。",
      "share.copy.3":             "做 AI 的可以试试 {{brand}}，已经成了我每天都开的工具。",
      "share.copy.4":             "{{brand}} 在我思考的时候默默把活干了，挺扎实的，分享一下。",
      ...
      "share.poster.tagline":     "我用 {{brand}} 把事情做得更快了。",
