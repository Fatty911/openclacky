...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "share.tooltip":            "Share",
      "share.copy":               "I'm building with {{brand}} — an AI agent that actually gets things done. Highly recommend.",
      "share.copied":             "Copied to clipboard",
      "share.copyFailed":         "Copy failed",
      "share.modal.title":        "Share {{brand}}",
      "share.modal.subtitle":     "Save the poster or copy the text, then post it anywhere.",
      ...
      "share.hint.xhs":           "Text copied — save the poster and post it on Xiaohongshu.",
      "share.hint.wechat":        "Text copied — save the poster and share it in WeChat Moments.",
    ...
    zh: {
      ...
      "share.tooltip":            "分享",
      "share.copy":               "我在用 {{brand}} —— 一个真正能把活干完的 AI 助手，强烈推荐。",
      "share.copied":             "已复制到剪贴板",
      "share.copyFailed":         "复制失败",
      "share.modal.title":        "分享 {{brand}}",
      "share.modal.subtitle":     "保存海报或复制文案，发到任意平台。",
      ...
      "share.hint.xhs":           "文案已复制 —— 保存海报后发到小红书吧。",
      "share.hint.wechat":        "文案已复制 —— 保存海报后分享到朋友圈吧。",
