...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "extensions.subtitle":      "Browse extensions that creators can bundle into brand packages. Extensions are delivered with your license — there is no direct download here.",
      ...
      "extensions.delivery":      "Delivered with your license",
      "mcp.loading":              "Loading…",
    ...
    zh: {
      ...
      "extensions.subtitle":      "浏览创作者可打包进品牌包的扩展。扩展随你的授权一起下发，此处不提供直接下载。",
