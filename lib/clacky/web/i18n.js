...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "settings.media.title":         "Media Models",
      "settings.media.desc":          "Optional. Image / video / audio / vision sidecar models.",
    ...
    zh: {
      ...
      "settings.media.title":         "多媒体模型",
      "settings.media.desc":          "可选。图片 / 视频 / 音频 / 视觉理解副模型。",
