      ...
      <div class="code-editor-modal">
        ...
        <div class="code-editor-footer">
          ...
          <div class="code-editor-actions">
            ${readOnly ? "" : `<button class="btn btn-secondary code-editor-cancel">${cancelLabel}</button><button class="btn btn-primary code-editor-save">${saveLabel}</button>`}
            ${readOnly ? `<button class="btn btn-secondary code-editor-cancel">${cancelLabel}</button>` : ""}
          </div>
        </div>
      </div>`;
