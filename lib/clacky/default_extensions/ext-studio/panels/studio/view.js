...
(function () {
  ...
  function runPublishFlow(ext, prevVersion) {
    return new Promise((resolve) => {
      ...
      const notes = el("textarea", { class: "studio-textarea", rows: "5", placeholder: t("pub.notes.placeholder") });
      ...
      async function submit() {
        ...
        try {
          ...
          if (data === null) {
            ...
            publishBtn.textContent = version ? t("pub.btn.publish", { ver: version }) : t("pub.btn.publish", { ver: "?" });
