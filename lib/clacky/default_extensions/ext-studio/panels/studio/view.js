...
(function () {
  ...
  function runPublishFlow(ext, prevVersion) {
    return new Promise((resolve) => {
      ...
      if (unitList) metaBlock.appendChild(el("span", { class: "studio-pub-units", text: unitList }));
  ...
  style.textContent = `
    ...
    .studio-modal { background: var(--color-bg-primary, var(--color-bg-secondary)); border: 1px solid var(--color-border-primary); border-radius: var(--radius-md, 8px); padding: 24px 24px 20px; width: 440px; max-width: calc(100vw - 40px); box-shadow: 0 12px 40px rgba(0,0,0,0.35); }
