    ...
    async function loadPublished() {
      ...
      try {
        ...
        exts.forEach((e) => {
          ...
          if (e.units && typeof e.units === "object") {
            const unitsText = formatUnits(e.units);
            if (unitsText) head.appendChild(el("span", { style: "font-size:11px;color:var(--color-text-muted);", text: unitsText }));
          }
